...
module TBA API v3 Ruby Client
  ...
  class DistrictRankingEventPoints
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'district_cmp')
        self.district_cmp = attributes[:'district_cmp']
      end

      if attributes.has_key?(:'alliance_points')
        self.alliance_points = attributes[:'alliance_points']
      end

      if attributes.has_key?(:'award_points')
        self.award_points = attributes[:'award_points']
      end

      if attributes.has_key?(:'qual_points')
        self.qual_points = attributes[:'qual_points']
      end

      if attributes.has_key?(:'elim_points')
    ...
    def hash
      [event_key, district_cmp, alliance_points, award_points, qual_points, elim_points, total].hash
    end
