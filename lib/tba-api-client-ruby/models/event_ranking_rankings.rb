...
module TBA API v3 Ruby Client
  ...
  class EventRankingRankings
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'matches_played')
        self.matches_played = attributes[:'matches_played']
      end

      if attributes.has_key?(:'qual_average')
    ...
    def hash
      [dq, matches_played, qual_average, rank, record, extra_stats, sort_orders, team_key].hash
    end
