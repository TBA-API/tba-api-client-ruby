...
module TBA API v3 Ruby Client
  ...
  class EventInsights2016
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'LowBar')
        if (value = attributes[:'LowBar']).is_a?(Array)
          self.low_bar = value
        end
      end

      if attributes.has_key?(:'A_ChevalDeFrise')
        if (value = attributes[:'A_ChevalDeFrise']).is_a?(Array)
          self.a_cheval_de_frise = value
        end
      end

      if attributes.has_key?(:'A_Portcullis')
        if (value = attributes[:'A_Portcullis']).is_a?(Array)
          self.a_portcullis = value
        end
      end

      if attributes.has_key?(:'B_Ramparts')
        if (value = attributes[:'B_Ramparts']).is_a?(Array)
          self.b_ramparts = value
        end
      end

      if attributes.has_key?(:'B_Moat')
        if (value = attributes[:'B_Moat']).is_a?(Array)
          self.b_moat = value
        end
      end

      if attributes.has_key?(:'C_SallyPort')
        if (value = attributes[:'C_SallyPort']).is_a?(Array)
          self.c_sally_port = value
        end
      end

      if attributes.has_key?(:'C_Drawbridge')
        if (value = attributes[:'C_Drawbridge']).is_a?(Array)
          self.c_drawbridge = value
        end
      end

      if attributes.has_key?(:'D_RoughTerrain')
        if (value = attributes[:'D_RoughTerrain']).is_a?(Array)
          self.d_rough_terrain = value
        end
      end

      if attributes.has_key?(:'D_RockWall')
        if (value = attributes[:'D_RockWall']).is_a?(Array)
      ...
      if attributes.has_key?(:'breaches')
        if (value = attributes[:'breaches']).is_a?(Array)
          self.breaches = value
        end
      end

      if attributes.has_key?(:'scales')
      ...
      if attributes.has_key?(:'captures')
