...
module TBA API v3 Ruby Client
  class Event
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'event_code')
      ...
      if attributes.has_key?(:'event_type_string')
