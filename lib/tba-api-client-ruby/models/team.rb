...
module TBA API v3 Ruby Client
  class Team
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'gmaps_place_id')
        self.gmaps_place_id = attributes[:'gmaps_place_id']
      end

      if attributes.has_key?(:'gmaps_url')
      ...
      if attributes.has_key?(:'rookie_year')
        self.rookie_year = attributes[:'rookie_year']
      end

      if attributes.has_key?(:'motto')
        self.motto = attributes[:'motto']
      end

      if attributes.has_key?(:'home_championship')
