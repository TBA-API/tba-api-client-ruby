...
module TBA API v3 Ruby Client
  class Team
    ...
    def hash
      [key, team_number, nickname, name, city, state_prov, country, address, postal_code, gmaps_place_id, gmaps_url, lat, lng, location_name, website, rookie_year, motto, home_championship].hash
    end
