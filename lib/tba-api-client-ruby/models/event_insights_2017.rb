...
module TBA API v3 Ruby Client
  ...
  class EventInsights2017
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'average_rotor_points')
        self.average_rotor_points = attributes[:'average_rotor_points']
      end

      if attributes.has_key?(:'average_rotor_points_auto')
        self.average_rotor_points_auto = attributes[:'average_rotor_points_auto']
      end

      if attributes.has_key?(:'average_rotor_points_teleop')
      ...
      if attributes.has_key?(:'average_takeoff_points_teleop')
      ...
      if attributes.has_key?(:'high_kpa')
