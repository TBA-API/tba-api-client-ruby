...
module TBA API v3 Ruby Client
  class TeamApi
    ...
    def get_district_rankings_with_http_info(district_key, opts = {})
      ...
      # resource path
      local_var_path = '/district/{district_key}/rankings'.sub('{' + 'district_key' + '}', CGI.escape(district_key.to_s).gsub('%2F', '/'))
    ...
    def get_district_teams_with_http_info(district_key, opts = {})
      ...
      # resource path
      local_var_path = '/district/{district_key}/teams'.sub('{' + 'district_key' + '}', CGI.escape(district_key.to_s).gsub('%2F', '/'))
    ...
    def get_district_teams_keys_with_http_info(district_key, opts = {})
      ...
      # resource path
      local_var_path = '/district/{district_key}/teams/keys'.sub('{' + 'district_key' + '}', CGI.escape(district_key.to_s).gsub('%2F', '/'))
    ...
    def get_district_teams_simple_with_http_info(district_key, opts = {})
      ...
      # resource path
      local_var_path = '/district/{district_key}/teams/simple'.sub('{' + 'district_key' + '}', CGI.escape(district_key.to_s).gsub('%2F', '/'))
    ...
    def get_team_with_http_info(team_key, opts = {})
      ...
      # resource path
      local_var_path = '/team/{team_key}'.sub('{' + 'team_key' + '}', CGI.escape(team_key.to_s).gsub('%2F', '/'))
    ...
    def get_team_awards_with_http_info(team_key, opts = {})
      ...
      # resource path
      local_var_path = '/team/{team_key}/awards'.sub('{' + 'team_key' + '}', CGI.escape(team_key.to_s).gsub('%2F', '/'))
    ...
    def get_team_awards_by_year_with_http_info(team_key, year, opts = {})
      ...
      # resource path
      local_var_path = '/team/{team_key}/awards/{year}'.sub('{' + 'team_key' + '}', CGI.escape(team_key.to_s).gsub('%2F', '/')).sub('{' + 'year' + '}', CGI.escape(year.to_s).gsub('%2F', '/'))
    ...
    def get_team_districts_with_http_info(team_key, opts = {})
      ...
      # resource path
      local_var_path = '/team/{team_key}/districts'.sub('{' + 'team_key' + '}', CGI.escape(team_key.to_s).gsub('%2F', '/'))
    ...
    def get_team_matches_by_year_with_http_info(team_key, year, opts = {})
      ...
      # resource path
      local_var_path = '/team/{team_key}/matches/{year}'.sub('{' + 'team_key' + '}', CGI.escape(team_key.to_s).gsub('%2F', '/')).sub('{' + 'year' + '}', CGI.escape(year.to_s).gsub('%2F', '/'))
    ...
    def get_team_matches_by_year_keys_with_http_info(team_key, year, opts = {})
      ...
      # resource path
      local_var_path = '/team/{team_key}/matches/{year}/keys'.sub('{' + 'team_key' + '}', CGI.escape(team_key.to_s).gsub('%2F', '/')).sub('{' + 'year' + '}', CGI.escape(year.to_s).gsub('%2F', '/'))
    ...
    def get_team_matches_by_year_simple_with_http_info(team_key, year, opts = {})
      ...
      # resource path
      local_var_path = '/team/{team_key}/matches/{year}/simple'.sub('{' + 'team_key' + '}', CGI.escape(team_key.to_s).gsub('%2F', '/')).sub('{' + 'year' + '}', CGI.escape(year.to_s).gsub('%2F', '/'))
    ...
    def get_team_media_by_tag_with_http_info(team_key, media_tag, opts = {})
      ...
      # resource path
      local_var_path = '/team/{team_key}/media/tag/{media_tag}'.sub('{' + 'team_key' + '}', CGI.escape(team_key.to_s).gsub('%2F', '/')).sub('{' + 'media_tag' + '}', CGI.escape(media_tag.to_s).gsub('%2F', '/'))
    ...
    def get_team_media_by_tag_year_with_http_info(team_key, media_tag, year, opts = {})
      ...
      # resource path
      local_var_path = '/team/{team_key}/media/tag/{media_tag}/{year}'.sub('{' + 'team_key' + '}', CGI.escape(team_key.to_s).gsub('%2F', '/')).sub('{' + 'media_tag' + '}', CGI.escape(media_tag.to_s).gsub('%2F', '/')).sub('{' + 'year' + '}', CGI.escape(year.to_s).gsub('%2F', '/'))
    ...
    def get_team_media_by_year_with_http_info(team_key, year, opts = {})
      ...
      # resource path
      local_var_path = '/team/{team_key}/media/{year}'.sub('{' + 'team_key' + '}', CGI.escape(team_key.to_s).gsub('%2F', '/')).sub('{' + 'year' + '}', CGI.escape(year.to_s).gsub('%2F', '/'))
    ...
    def get_team_robots_with_http_info(team_key, opts = {})
      ...
      # resource path
      local_var_path = '/team/{team_key}/robots'.sub('{' + 'team_key' + '}', CGI.escape(team_key.to_s).gsub('%2F', '/'))
    ...
    def get_team_simple_with_http_info(team_key, opts = {})
      ...
      # resource path
      local_var_path = '/team/{team_key}/simple'.sub('{' + 'team_key' + '}', CGI.escape(team_key.to_s).gsub('%2F', '/'))
    ...
    def get_team_social_media_with_http_info(team_key, opts = {})
      ...
      # resource path
      local_var_path = '/team/{team_key}/social_media'.sub('{' + 'team_key' + '}', CGI.escape(team_key.to_s).gsub('%2F', '/'))
    ...
    def get_team_years_participated_with_http_info(team_key, opts = {})
      ...
      # resource path
      local_var_path = '/team/{team_key}/years_participated'.sub('{' + 'team_key' + '}', CGI.escape(team_key.to_s).gsub('%2F', '/'))
    ...
    def get_teams_with_http_info(page_num, opts = {})
      ...
      # resource path
      local_var_path = '/teams/{page_num}'.sub('{' + 'page_num' + '}', CGI.escape(page_num.to_s).gsub('%2F', '/'))
    ...
    def get_teams_by_year_with_http_info(year, page_num, opts = {})
      ...
      # resource path
      local_var_path = '/teams/{year}/{page_num}'.sub('{' + 'year' + '}', CGI.escape(year.to_s).gsub('%2F', '/')).sub('{' + 'page_num' + '}', CGI.escape(page_num.to_s).gsub('%2F', '/'))
    ...
    def get_teams_by_year_keys_with_http_info(year, page_num, opts = {})
      ...
      # resource path
      local_var_path = '/teams/{year}/{page_num}/keys'.sub('{' + 'year' + '}', CGI.escape(year.to_s).gsub('%2F', '/')).sub('{' + 'page_num' + '}', CGI.escape(page_num.to_s).gsub('%2F', '/'))
    ...
    def get_teams_by_year_simple_with_http_info(year, page_num, opts = {})
      ...
      # resource path
      local_var_path = '/teams/{year}/{page_num}/simple'.sub('{' + 'year' + '}', CGI.escape(year.to_s).gsub('%2F', '/')).sub('{' + 'page_num' + '}', CGI.escape(page_num.to_s).gsub('%2F', '/'))
    ...
    def get_teams_keys_with_http_info(page_num, opts = {})
      ...
      # resource path
      local_var_path = '/teams/{page_num}/keys'.sub('{' + 'page_num' + '}', CGI.escape(page_num.to_s).gsub('%2F', '/'))
    ...
    def get_teams_simple_with_http_info(page_num, opts = {})
      ...
      # resource path
      local_var_path = '/teams/{page_num}/simple'.sub('{' + 'page_num' + '}', CGI.escape(page_num.to_s).gsub('%2F', '/'))
