...
module TBA API v3 Ruby Client
  class TeamApi
    ...
    def get_team_with_http_info(team_key, opts = {})
      ...
      # resource path
      local_var_path = '/team/{team_key}'.sub('{' + 'team_key' + '}', CGI.escape(team_key.to_s))
    ...
    def get_team_awards_with_http_info(team_key, opts = {})
      ...
      # resource path
      local_var_path = '/team/{team_key}/awards'.sub('{' + 'team_key' + '}', CGI.escape(team_key.to_s))
    ...
    def get_team_media_by_tag_with_http_info(team_key, media_tag, opts = {})
      ...
      # resource path
      local_var_path = '/team/{team_key}/media/tag/{media_tag}'.sub('{' + 'team_key' + '}', CGI.escape(team_key.to_s)).sub('{' + 'media_tag' + '}', CGI.escape(media_tag.to_s))
    ...
    def get_team_media_by_tag_year_with_http_info(team_key, media_tag, year, opts = {})
      ...
      # resource path
      local_var_path = '/team/{team_key}/media/tag/{media_tag}/{year}'.sub('{' + 'team_key' + '}', CGI.escape(team_key.to_s)).sub('{' + 'media_tag' + '}', CGI.escape(media_tag.to_s)).sub('{' + 'year' + '}', CGI.escape(year.to_s))
    ...
    def get_team_media_by_year_with_http_info(team_key, year, opts = {})
      ...
      # resource path
      local_var_path = '/team/{team_key}/media/{year}'.sub('{' + 'team_key' + '}', CGI.escape(team_key.to_s)).sub('{' + 'year' + '}', CGI.escape(year.to_s))
    ...
    def get_team_robots_with_http_info(team_key, opts = {})
      ...
      # resource path
      local_var_path = '/team/{team_key}/robots'.sub('{' + 'team_key' + '}', CGI.escape(team_key.to_s))
    ...
    def get_team_simple_with_http_info(team_key, opts = {})
      ...
      # resource path
      local_var_path = '/team/{team_key}/simple'.sub('{' + 'team_key' + '}', CGI.escape(team_key.to_s))
    ...
    def get_teams_with_http_info(page_num, opts = {})
      ...
      # resource path
      local_var_path = '/teams/{page_num}'.sub('{' + 'page_num' + '}', CGI.escape(page_num.to_s))
    ...
    def get_teams_keys_with_http_info(page_num, opts = {})
      ...
      # resource path
      local_var_path = '/teams/{page_num}/keys'.sub('{' + 'page_num' + '}', CGI.escape(page_num.to_s))
    ...
    def get_teams_simple_with_http_info(page_num, opts = {})
      ...
      # resource path
      local_var_path = '/teams/{page_num}/simple'.sub('{' + 'page_num' + '}', CGI.escape(page_num.to_s))
