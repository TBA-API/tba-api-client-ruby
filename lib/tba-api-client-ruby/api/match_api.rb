...
module TBA API v3 Ruby Client
  class MatchApi
    ...
    def get_match_with_http_info(match_key, opts = {})
      ...
      # resource path
      local_var_path = '/match/{match_key}'.sub('{' + 'match_key' + '}', CGI.escape(match_key.to_s).gsub('%2F', '/'))
    ...
    def get_match_simple_with_http_info(match_key, opts = {})
      ...
      # resource path
      local_var_path = '/match/{match_key}/simple'.sub('{' + 'match_key' + '}', CGI.escape(match_key.to_s).gsub('%2F', '/'))
    ...
    def get_match_timeseries_with_http_info(match_key, opts = {})
      ...
      # resource path
      local_var_path = '/match/{match_key}/timeseries'.sub('{' + 'match_key' + '}', CGI.escape(match_key.to_s).gsub('%2F', '/'))
