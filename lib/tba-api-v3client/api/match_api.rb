...
module TBA API v3 Ruby Client
  class MatchApi
    ...
    # @param match_key [String] TBA Match Key, eg &#x60;2016nytr_qm1&#x60;
    # @param [Hash] opts the optional parameters
    # @option opts [String] :if_modified_since Value of the &#x60;Last-Modified&#x60; header in the most recently cached response by the client.
    # @return [Match]
    ...
    def get_match_with_http_info(match_key, opts = {})
      ...
      # resource path
      local_var_path = '/match/{match_key}'.sub('{' + 'match_key' + '}', CGI.escape(match_key.to_s))
    ...
    def get_match_simple_with_http_info(match_key, opts = {})
      ...
      # resource path
      local_var_path = '/match/{match_key}/simple'.sub('{' + 'match_key' + '}', CGI.escape(match_key.to_s))
    ...
    def get_match_timeseries_with_http_info(match_key, opts = {})
      ...
      # resource path
      local_var_path = '/match/{match_key}/timeseries'.sub('{' + 'match_key' + '}', CGI.escape(match_key.to_s))
    ...
    # @option opts [String] :if_modified_since Value of the &#x60;Last-Modified&#x60; header in the most recently cached response by the client.
    # @return [Zebra]
    def get_match_zebra(match_key, opts = {})
      data, _status_code, _headers = get_match_zebra_with_http_info(match_key, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [String] :if_modified_since Value of the &#x60;Last-Modified&#x60; header in the most recently cached response by the client.
    # @return [Array<(Zebra, Integer, Hash)>] Zebra data, response status code and response headers
    def get_match_zebra_with_http_info(match_key, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: MatchApi.get_match_zebra ...'
      end
      # verify the required parameter 'match_key' is set
      if @api_client.config.client_side_validation && match_key.nil?
        fail ArgumentError, "Missing the required parameter 'match_key' when calling MatchApi.get_match_zebra"
      end
      # resource path
      local_var_path = '/match/{match_key}/zebra_motionworks'.sub('{' + 'match_key' + '}', CGI.escape(match_key.to_s))
      ...
      # return_type
      return_type = opts[:return_type] || 'Zebra' 
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: MatchApi#get_match_zebra\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
