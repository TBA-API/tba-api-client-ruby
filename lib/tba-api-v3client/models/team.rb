...
module TBA API v3 Ruby Client
  class Team
    ...
    attr_accessor :home_championship
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `TBA API v3 Ruby Client::Team` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `TBA API v3 Ruby Client::Team`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'rookie_year')
        self.rookie_year = attributes[:'rookie_year']
      end

      if attributes.key?(:'motto')
        self.motto = attributes[:'motto']
      end

      if attributes.key?(:'home_championship')
        self.home_championship = attributes[:'home_championship']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          motto == o.motto &&
          home_championship == o.home_championship
    end
    ...
    def hash
      [key, team_number, nickname, name, school_name, city, state_prov, country, address, postal_code, gmaps_place_id, gmaps_url, lat, lng, location_name, website, rookie_year, motto, home_championship].hash
    end
