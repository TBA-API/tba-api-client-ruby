...
module SwaggerClient
  ...
  class MatchScoreBreakdown2017Alliance
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'rotor1Auto')
        self.rotor1_auto = attributes[:'rotor1Auto']
      end

      if attributes.has_key?(:'rotor2Auto')
        self.rotor2_auto = attributes[:'rotor2Auto']
      end

      if attributes.has_key?(:'autoFuelLow')
        self.auto_fuel_low = attributes[:'autoFuelLow']
      end

      if attributes.has_key?(:'autoFuelHigh')
        self.auto_fuel_high = attributes[:'autoFuelHigh']
      end

      if attributes.has_key?(:'autoMobilityPoints')
        self.auto_mobility_points = attributes[:'autoMobilityPoints']
      end

      if attributes.has_key?(:'autoRotorPoints')
        self.auto_rotor_points = attributes[:'autoRotorPoints']
      end

      if attributes.has_key?(:'autoFuelPoints')
        self.auto_fuel_points = attributes[:'autoFuelPoints']
      end

      if attributes.has_key?(:'teleopFuelPoints')
        self.teleop_fuel_points = attributes[:'teleopFuelPoints']
      end

      if attributes.has_key?(:'teleopFuelLow')
        self.teleop_fuel_low = attributes[:'teleopFuelLow']
      end

      if attributes.has_key?(:'teleopFuelHigh')
        self.teleop_fuel_high = attributes[:'teleopFuelHigh']
      end

      if attributes.has_key?(:'teleopRotorPoints')
        self.teleop_rotor_points = attributes[:'teleopRotorPoints']
      end

      if attributes.has_key?(:'kPaRankingPointAchieved')
        self.k_pa_ranking_point_achieved = attributes[:'kPaRankingPointAchieved']
      end

      if attributes.has_key?(:'teleopTakeoffPoints')
        self.teleop_takeoff_points = attributes[:'teleopTakeoffPoints']
      end

      if attributes.has_key?(:'kPaBonusPoints')
        self.k_pa_bonus_points = attributes[:'kPaBonusPoints']
      end

      if attributes.has_key?(:'rotorBonusPoints')
        self.rotor_bonus_points = attributes[:'rotorBonusPoints']
      end

      if attributes.has_key?(:'rotor1Engaged')
        self.rotor1_engaged = attributes[:'rotor1Engaged']
      end

      if attributes.has_key?(:'rotor2Engaged')
        self.rotor2_engaged = attributes[:'rotor2Engaged']
      end

      if attributes.has_key?(:'rotor3Engaged')
        self.rotor3_engaged = attributes[:'rotor3Engaged']
      end

      if attributes.has_key?(:'rotor4Engaged')
        self.rotor4_engaged = attributes[:'rotor4Engaged']
      end

      if attributes.has_key?(:'rotorRankingPointAchieved')
        self.rotor_ranking_point_achieved = attributes[:'rotorRankingPointAchieved']
      end
      ...
      if attributes.has_key?(:'touchpadNear')
        self.touchpad_near = attributes[:'touchpadNear']
      end

      if attributes.has_key?(:'touchpadMiddle')
        self.touchpad_middle = attributes[:'touchpadMiddle']
      end

      if attributes.has_key?(:'touchpadFar')
        self.touchpad_far = attributes[:'touchpadFar']
      end
