...
# Unit tests for TBA API v3 Ruby Client::MatchScoreBreakdown2017
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'MatchScoreBreakdown2017' do
  before do
    # run before each test
    @instance = TBA API v3 Ruby Client::MatchScoreBreakdown2017.new
  end
  ...
  describe 'test an instance of MatchScoreBreakdown2017' do
    it 'should create an instance of MatchScoreBreakdown2017' do
      expect(@instance).to be_instance_of(TBA API v3 Ruby Client::MatchScoreBreakdown2017)
    end
  end
